...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddOrder.setOnClickListener(v -> {
            ...
            if (!unit.isEmpty() && !name.isEmpty() && !date.isEmpty() && !time.isEmpty() && !description.isEmpty() && !plantonista.isEmpty()) {
                ...
                sendWhatsAppMessage(unit, name, date, time, description, plantonista, currentPhotoPath);
            } else {
    ...
    private void sendWhatsAppMessage(String unit, String name, String date, String
            time, String description, String plantonista, @Nullable String photoPath) {
